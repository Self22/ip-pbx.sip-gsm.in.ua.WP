...
function theme_options_add_page() {
	add_theme_page( __( 'Настройки темы Евро-тел', 'sampletheme' ), __( 'Настройки темы Евро-тел', 'sampletheme' ), 'edit_theme_options', 'theme_options', 'theme_options_do_page' );
}
...
$select_options = array(
	'classic' => array(
		'value' =>	'classic',
		'label' => __( 'classic', 'sampletheme' )
	),
	'notclassic' => array(
		'value' =>	'notclassic',
		'label' => __( 'notclassic', 'sampletheme' )
	)
